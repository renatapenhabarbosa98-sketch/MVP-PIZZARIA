# Generated by Django 5.2.14 on 2026-05-21 01:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='produto',
            name='categoria',
            field=models.CharField(blank=True, db_column='categoria', default='', max_length=100),
        ),
        migrations.AddField(
            model_name='produto',
            name='categoria_id',
            field=models.IntegerField(blank=True, db_column='categoria_id', null=True),
        ),
        ...
        migrations.AlterField(
            model_name='pedido',
            name='status',
            field=models.CharField(db_column='status_pedido', default='Em preparo', max_length=30),
        ),
        migrations.AlterField(
            model_name='pedido',
            name='total',
            field=models.DecimalField(db_column='total_consumo', decimal_places=2, default=0, max_digits=10),
        ),
        migrations.AlterField(
            model_name='produto',
            name='nome',
